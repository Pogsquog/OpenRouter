...
project = 'OpenRouter Python Library'
copyright = '2025, OpenRouter Python Library Contributors'
author = 'OpenRouter Python Library Contributors'
release = '0.1.0'
...
html_theme = 'alabaster'  # You can change this to 'sphinx_rtd_theme' if preferred
